...
## This is here so configs done via the GUyI are still loaded.
...
c.bindings.key_mappings = {'<Ctrl-g>': '<Escape>', '<Ctrl-x><Ctrl-k>': '<Ctrl-x><Ctrl-0>'}
...
## Type: Font
c.fonts.tabs.selected = '18 default_family'

## Font used for unselected tabs.
## Type: Font
c.fonts.tabs.unselected = '18 default_family'
...
c.statusbar.widgets = ['url', 'progress', 'history']
...
# config.bind('<Ctrl-c><E>', 'edit-text', mode='insert')
